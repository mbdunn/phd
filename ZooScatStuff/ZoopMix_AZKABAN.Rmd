...
pm = data.frame(species=c('Copepods','Euphausiids','Chaetognaths','Jellyfish'),
  ...
  g_dist = 'rnorm',
  g_mean = c(0.995,1.037, 1.03, 1.007),
  g_sd   = c(0.001,0.005, 0.005, 0.005),
  h_dist = 'rnorm',
  h_mean = c(0.959,1.026, 1.03, 1.007),
  h_sd   = c(0.01,0.005, 0.005, 0.005),
  theta_dist = 'rnorm',
...
```{r export-feather}
path <- "AZKABAN_ZoopMix_data_newcopepod.feather"
