...
pm = data.frame(species=c('Copepod','Krill', 'Amphipod'),
  L_dist=c('gamma', 'log normal','gamma'),
  L_shape =  c(7,     1.47, 9.9),
  L_rate =   c(4,     0.31,  2.2),
  L_a_dist = c('normal'),
