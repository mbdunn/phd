...
pm = data.frame(species=c('Copepod','Euphausiid larvae', 'Amphipod'),
  ...
  g_dist = 'runif',
  g_min = c(0.993,1.033, 1.053),
  g_max = c(0.999,1.043, 1.063),
  h_dist = 'runif',
  h_min = c(1.022,1.021, 1.053),
  h_max = c(1.032,1.031, 1.063),
  theta_dist = 'rnorm',
  theta_mean = c(90, 20,    0),
  theta_sd =   c(30, 20,   30),
  rho_l =    c(  3,   3,    13),
  taper =    c(  2,   4,    4) #taper =2 L/a>2 prolate spheroid, others selected from ZooScat Ex.
)
```
