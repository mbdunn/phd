...
pm = data.frame(species=c('Copepod','Krill','Chaetognaths','KrillBig', 'Amphipod', 'Limacina', 'FishLarvae'),
  L_dist=c('gamma', 'gamma','log normal', 'log normal','gamma', 'gamma', 'norm'),
  L_shape =  c(7,    15,     2,     0.85,10,  6.8,   29.6),
  L_rate =   c(4,     4,   0.4,     0.46, 2,  4.8,   9.6),
  L_a_dist = c('normal'),
  L_a_mean = c(2.7,10.5, 17.15, 10.5,     3,  2.5,   8.5),
  L_a_sd =   c(0.2, 0.2,     3,  0.2,     1,  0.1,   2),
  g_dist = 'uniform',
  g_min = c(1.019,1.011, 1.025, 1.033,1.053, 1.725, 0.993),
  g_max = c(1.034,1.021, 1.035, 1.043,1.058, 1.735, 1.003),
  h_dist = 'uniform',
  h_min = c(1.021,1.014, 1.025, 1.021,1.053, 1.725, 1.105),
  h_max = c(1.032,1.024, 1.035, 1.031,1.058, 1.735, 1.115),
  theta_dist='uniform',
  theta_mean = c(90, 20,     0,    20,    0,    20,     0),
  theta_sd =   c(30, 20,    30,    20,   30,    20,    30),
