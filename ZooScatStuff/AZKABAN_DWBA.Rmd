---
title: "TS simulations for AZKABAN calanus (to start)"
author: "Muriel Dunn"
date: "01/06/2021"
output:
  html_document:
...
We subsampled the net sampled and found 57 % is copepods. We will start by modeling just the copepods then add fish eggs, fish larvae and decapod larvae if interesting
...
pm = data.frame(species=c('Copepod', 'Krill'),
  L_dist=c('normal', 'normal'),
  L_shape =  c(0.293, 0.47), #cm
  L_rate =   c(0.01, 0.01), #cm
  L_a_dist = c('normal', 'normal'),
  L_a_mean = c(2.7, 10.5),
  L_a_sd =   c(0.2, 0.1),
  g_dist = 'uniform',
  g_min = c(1.019,1.033),
