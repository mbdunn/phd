...
```{r}
Lima_dist = fitdist(c(x_Limacina_TT, x_Limacina_MN, x_Limacinewidth), "gamma")
...
```{r}
codTuckLength_dist = fitdist(((x_codR3*8.77)+(3.24/2))*2, "lnorm")
mean(((x_codR3*8.77)+(3.24/2))*2)
sd(((x_codR3*8.77)+(3.24/2))*2)
